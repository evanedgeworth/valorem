...
import { formatNumber, formatToUSD } from "@/utils/commonUtils";
...
const DashboardPageContent: FC<DashboardPageData> = function ({ dashboard }) {
  return (
    <div className="px-4 pt-6">
      ...
      <div className="my-4 grid w-full grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-2">
    ...
    <div className="rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-6 xl:p-8">
      <div className="mb-4 flex items-center justify-between">
        <div className="shrink-0">
          ...
          <h3 className="text-base font-normal text-gray-600 dark:text-gray-400">Savings this week</h3>
        </div>
    ...
    <div className="rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-6 xl:p-8">
      <div className="flex items-center">
        <div className="shrink-0">
          ...
          <h3 className="text-base font-normal text-gray-600 dark:text-gray-400">Recent Savings</h3>
        </div>
        <div className="ml-5 flex w-0 flex-1 items-center justify-end text-base font-bold text-green-500 dark:text-green-400">
...
const UserSignupsThisWeek: FC<DashboardPageData> = function ({ dashboard }) {
  ...
  return (
    <div className="rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-6 xl:p-8">
      <div className="mb-4 flex items-center justify-between">
        <div>
          <h3 className="mb-2 text-xl font-bold text-gray-900 dark:text-white">Recent Activity</h3>
          <span className="text-base font-normal text-gray-600 dark:text-gray-400">This is a list of the latest activity</span>
        </div>
        <div className="shrink-0">
          <Link
            href="#"
            ...
            <div className="overflow-hidden shadow sm:rounded-lg">
              <Table striped className="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                ...
                <Table.Body className="bg-white dark:bg-gray-800">
                  {/* {dashboard.transactions.splice(0, 5).map(({ transaction, date, amount, status }) => (
                    <Table.Row key={`${transaction}-${date}-${amount}`}>
                      <Table.Cell className="whitespace-nowrap p-4 text-sm font-normal text-gray-900 dark:text-white">{transaction}</Table.Cell>
                    </Table.Row>
                  ))} */}
                </Table.Body>
              </Table>
      ...
      <ul className="space-y-6">
        <li className="w-full items-center sm:flex">
          ...
          <div className="h-5 w-full rounded-lg bg-gray-200 dark:bg-gray-700">
            <div className="h-5 rounded-md bg-primary-700 p-1 text-center text-xs font-bold leading-none text-primary-100" style={{ width: "35%" }}>
              35%
            </div>
          </div>
        </li>
        <li className="w-full items-center sm:flex">
          ...
          <div className="h-5 w-full rounded-lg bg-gray-200 dark:bg-gray-700">
            <div className="h-5 rounded-md bg-primary-700 p-1 text-center text-xs font-bold leading-none text-primary-100" style={{ width: "26%" }}>
              26%
            </div>
          </div>
        </li>
        <li className="w-full items-center sm:flex">
          ...
          <div className="h-5 w-full rounded-lg bg-gray-200 dark:bg-gray-700">
            <div className="h-5 rounded-md bg-primary-700 p-1 text-center text-xs font-bold leading-none text-primary-100" style={{ width: "18%" }}>
              18%
            </div>
          </div>
        </li>
        <li className="w-full items-center sm:flex">
          ...
          <div className="h-5 w-full rounded-lg bg-gray-200 dark:bg-gray-700">
            <div className="h-5 rounded-md bg-primary-700 p-1 text-center text-xs font-bold leading-none text-primary-100" style={{ width: "14%" }}>
              14%
            </div>
          </div>
        </li>
        <li className="w-full items-center sm:flex">
          ...
          <div className="h-5 w-full rounded-lg bg-gray-200 dark:bg-gray-700">
            <div className="h-5 rounded-md bg-primary-700 p-1 text-center text-xs font-bold leading-none text-primary-100" style={{ width: "10%" }}>
              10%
            </div>
          </div>
        </li>
        <li className="w-full items-center sm:flex">
          ...
          <div className="h-5 w-full rounded-lg bg-gray-200 dark:bg-gray-700">
            <div className="h-5 rounded-md bg-primary-700 p-1 text-center text-xs font-bold leading-none text-primary-100" style={{ width: "7%" }}>
              7%
            </div>
          </div>
        </li>
...
const AcquisitionOverview: FC<DashboardPageData> = function ({ dashboard }) {
  return (
    <div className="rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-6 xl:p-8">
      <h3 className="text-xl font-bold leading-none text-gray-900 dark:text-white">Spending Overview</h3>
      <div className="my-6">
